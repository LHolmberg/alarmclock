import cv2
import numpy as np
original = cv2.imread('C:\\Users\\Lukaz\\OneDrive\\Skrivbord\\a.jpg', cv2.IMREAD_COLOR)
image_to_compare = cv2.imread('C:\\Users\\Lukaz\\OneDrive\\Skrivbord\\feature_matching.jpg', cv2.IMREAD_COLOR)
